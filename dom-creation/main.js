...
function renderPokemon(pokemon) {
  ...
  name.appendChild(pokeName);

  card.appendChild(name);

  var num = document.createElement('h3');
  var pokeNum = document.createTextNode(pokemon.number);
  num.appendChild(pokeNum);

  card.appendChild(num);

  var info = document.createElement('p');
  var pokeInfo = document.createTextNode(pokemon.description);

  info.appendChild(pokeInfo);
